...
import Attendance3 from './Attendance3.js';
...
import Studentmanagment3 from './studentmanagment3.js';
...
import FeeStructure3 from './FeeStructure3.js';
        ...
        <div className="d-flex" style={{ height: "88vh" }}>
            ...
            <ul className="list-unstyled">
              ...
              <li className="py-3 ">
                <div   style={{ textAlign: "left" }}>
                  ...
                  <NavLink to="/studentmanagment3" activeClassName="active" className="text-decoration-none text-white"  onClick={handleLinkClick} style={{ fontFamily: "Arial, sans-serif", fontSize: "0.9rem", fontWeight: "bold", textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)"  }}>Student</NavLink>
                </div>
              </li>
              ...
              <li className="py-3">
                <div  style={{ textAlign: "left" }}>
                  ...
                  <NavLink to="/Attendance3" activeClassName="active" className="text-decoration-none text-white" onClick={handleLinkClick} style={{ fontFamily: "Arial, sans-serif", fontSize: "0.9rem", fontWeight: "bold", textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)"  }}>Attendance</NavLink>
                </div>
              </li>
              ...
              <li className="py-3 text-center">
                <div style={{ textAlign: "left" }}>
                  ...
                  <NavLink to="/FeeStructure3" activeClassName="active" className="text-decoration-none text-white" onClick={handleLinkClick} style={{ fontFamily: "Arial, sans-serif", fontSize: "0.9rem", fontWeight: "bold", textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)"  }}>Fees</NavLink>
                </div>
              </li>
          ...
          <div className="content" style={contentStyles}>
            ...
            <Routes>
              ...
              <Route path="/Attendance3" element={<Attendance3/>} />
              ...
              <Route path="/studentmanagment3" element={<Studentmanagment3 />} />
              <Route path="/emp" element={<EmployeeList />} />
              <Route path="/IDGenerate" element={<IDGenerate />} />
              <Route path="/Studentregistration" element={<Studentregistration />} />
              <Route path="/Admission" element={<Admission />} />
              <Route path="/FeeStructure3" element={<FeeStructure3 />} />
