  ...
  return (
    <div>
      ...
      <div style={navbarStyles}>
        <h2 style={{ margin: 0, fontSize: '24px', fontWeight: 'bold', color: '#333' }}>Account Management</h2>
        <ul style={{ padding: 8 }}>
          <li style={navbarItemStyles} onClick={() => toggleDropdown(0)}> {/* Toggle dropdown when clicking */}
            <FontAwesomeIcon icon={faUser} style={{ marginRight: "10px" }} />
            <Link to="/Addnew" style={{ textDecoration: 'none', color: 'inherit' }}>Add Account</Link>
              {/* Dropdown content */}
          ...
          <li style={navbarItemStyles} onClick={() => toggleDropdown(0)}> {/* Toggle dropdown when clicking */}
            ...
            <Link to="/Addvendar" style={{ textDecoration: 'none', color: 'inherit' }}>Vender Info</Link>
              {/* Dropdown content */}
          ...
          <li style={navbarItemStyles} onClick={() => toggleDropdown(0)}> {/* Toggle dropdown when clicking */}
            ...
            <Link to="/Expense" style={{ textDecoration: 'none', color: 'inherit' }}>Expenses</Link>
              {/* Dropdown content */}
