...
const MatrixTable = () => {
  ...
  const attendanceData = [
    { sno: 1, rollNo: '001', studentName: 'John Doe', class: '9', section: 'A',month:'March', present: 'Yes', absent: 'No', leave: 'No' }
        ...
        <tbody>
          ...
          {attendanceData.map((record, idx) => (
            <tr key={idx}>
              ...
              <td>{record.month}</td> {/* Displaying month */}
...
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import { faHome } from '@fortawesome/free-solid-svg-icons';
// import MatrixTable from './MatrixTable'; // Assuming MatrixTable is in a separate file
...
//           </div>
//         </div>
//         {/* Render MatrixTable component with attendance data, selectedClass, and selectedSection */}
//         <MatrixTable attendanceData={attendanceData} selectedClass={selectedClass} selectedSection={selectedSection} />
//       </div>
//       {/* View Attendance section */}
//       <div className="view-attendance-container">
//         <div className="view-attendance-box">
