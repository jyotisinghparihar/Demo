  ...
  return (
    <div className='container-fluid'>
      ...
      <div className="row bg-primary text-white p-3">
        ...
        <label htmlFor="languageSelect" className="mr-3 mb-0"  style={{ fontWeight: 'bold' }}>Language:  </label>
        ...
        <div className="col">
          <form className="row g-3 p-3">
            <div className="col-md-6">
              <label htmlFor="VendorName" className="form-label"style={{ fontWeight: 'bold' }}>Vendor Name:</label>
            ...
            <div className="col-md-6">
              <label htmlFor="VendorContact" className="form-label"style={{ fontWeight: 'bold' }}>Vendor Contact:</label>
            ...
            <div className="col-md-6">
              <label htmlFor="VendorEMail" className="form-label"style={{ fontWeight: 'bold' }}>Vendor Email:</label>
            ...
            <div className="col-md-6">
              <label htmlFor="VendorAddress" className="form-label"style={{ fontWeight: 'bold' }}>Vendor Address:</label>
            ...
            <div className="col-md-6">
              <label htmlFor="VendorRemark" className="form-label"style={{ fontWeight: 'bold' }}>Vendor Remark:</label>
